...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      <div className="flex flex-col items-center justify-center w-full md:w-4/5 rounded-md bg-dark dark:bg-accentDark/90">
        ...
        <p className="mt-5 px-4 text-center w-full sm:w-3/5 font-light dark:font-medium text-sm sm:text-base dark:text-light">
      ...
      <div className="dark:bg-accentDark/90 bg-dark w-full mt-16 relative font-medium border-t border-solid border-light p-2 md:py-4 md:px-8 flex flex-col md:flex-row items-center justify-between rounded-xl">
        <Link href="/sitemap.xml" className="text-center underline md:my-0">
