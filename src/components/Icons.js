...
export const YoutubeIcon = ({ className, uid, ...rest }) => (
  <svg
...
export const SunIcon = ({ className, uid, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    >
      ...
      <mask id={`lineMdMoonFilledToSunnyFilledLoopTransition${uid}`}>
      ...
      <circle
        ...
        r="10"
        fill="currentColor"
        mask={`url(#lineMdMoonFilledToSunnyFilledLoopTransition${uid})`}
        opacity="0"
      >
...
export const MoonIcon = ({ className, uid, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    >
      ...
      <g fill="currentColor" fillOpacity="0">
        <path d="m15.22 6.03l2.53-1.94L14.56 4L13.5 1l-1.06 3l-3.19.09l2.53 1.94l-.91 3.06l2.63-1.81l2.63 1.81z">
          <animate
            id={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}`}
            fill="freeze"
            attributeName="fill-opacity"
            begin={`0.6s;lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+6s`}
            dur="0.4s"
            values="0;1"
          />
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+2.2s`}
            dur="0.4s"
            values="1;0"
          />
        </path>
        <path d="M13.61 5.25L15.25 4l-2.06-.05L12.5 2l-.69 1.95L9.75 4l1.64 1.25l-.59 1.98l1.7-1.17l1.7 1.17z">
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+3s`}
            dur="0.4s"
            values="0;1"
          />
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+5.2s`}
            dur="0.4s"
            values="1;0"
          />
        </path>
        <path d="M19.61 12.25L21.25 11l-2.06-.05L18.5 9l-.69 1.95l-2.06.05l1.64 1.25l-.59 1.98l1.7-1.17l1.7 1.17z">
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+0.4s`}
            dur="0.4s"
            values="0;1"
          />
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+2.8s`}
            dur="0.4s"
            values="1;0"
          />
        </path>
        <path d="m20.828 9.731l1.876-1.439l-2.366-.067L19.552 6l-.786 2.225l-2.366.067l1.876 1.439L17.601 12l1.951-1.342L21.503 12z">
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+3.4s`}
            dur="0.4s"
            values="0;1"
          />
          <animate
            fill="freeze"
            attributeName="fill-opacity"
            begin={`lineMdSunnyFilledLoopToMoonFilledLoopTransition${uid}.begin+5.6s`}
            dur="0.4s"
            values="1;0"
          />
        </path>
...
export const LinkedinIcon = ({ className, uid, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const TwitterIcon = ({ className, uid, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const GithubIcon = ({ className, uid, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const DribbbleIcon = ({ className, uid, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
